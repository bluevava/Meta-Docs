...
The tools/clients listed here use or include the mihomo core. We **do not directly control** development of these tools/clients. They may not include the latest features and fixes from the official version. For any issues caused by components **outside the core**, please report them to the corresponding third-party tool/client projects.
...
|[Jeemi](https://github.com/bluevava/jeemi-android)|Maintained |
...
|Project | Maintenance Status | Notes |
|:----|:----|:----|
|[OpenClash](https://github.com/vernesong/OpenClash)|Maintained |
|[OpenWrt-nikki](https://github.com/nikkinikki-org/OpenWrt-nikki)|Maintained |
|[FullCombo Shark](https://github.com/fcshark-org/openwrt-fchomo)|Maintained|
...
|Project | Maintenance Status | Notes |
|:----|:----|:----|
|[ClashBox](https://github.com/xiaobaigroup/ClashBox)|Maintained | Frontend is open-source; build is not reproducible |

## Steam OS

|Project | Maintenance Status | Notes |
|:----|:----|:----|
|[DeckyClash](https://github.com/chenx-dust/DeckyClash)|Maintained |
|[ToMoon](https://github.com/YukiCoco/ToMoon)|Maintained |
